...
public class EditCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Dùng lại giao diện tạo danh mục hiện tại
        ...
        ImageView imgBack =
                findViewById(R.id.imgCreateCategoryBack);

        edtCategoryName =
                findViewById(R.id.edtCategoryName);

        tabChiTieu =
                findViewById(R.id.tabCreateExpense);

        tabThuNhap =
                findViewById(R.id.tabCreateIncome);

        layoutIcons =
                findViewById(R.id.layoutCategoryIcons);

        GridLayout layoutColors =
                findViewById(R.id.layoutCategoryColors);
        ...
        // Giá trị mặc định nếu dữ liệu bị thiếu
        if (selectedType == null) {
            selectedType = TYPE_EXPENSE;
        }

        if (selectedIcon == null
                || selectedIcon.trim().isEmpty()) {
        ...
        // Tạo icon + màu theo dữ liệu hiện tại
        createIconChoices();
        ...
        tabChiTieu.setOnClickListener(
                view -> changeCategoryType(TYPE_EXPENSE)
        );

        tabThuNhap.setOnClickListener(
                view -> changeCategoryType(TYPE_INCOME)
        );
    ...
    private void createColorChoices(
        ...
        for (String color : colors) {
            ...
            colorView.setContentDescription(
                    "Chọn màu " + color
            );
    ...
    private void refreshColorSelection() {
        ...
        for (View colorView : colorViews) {
            ...
            String color =
                    (String) colorView.getTag();

            boolean selected =
                    selectedColor.equals(color);
    ...
    private void setupSafeArea() {
        ...
        View content =
                findViewById(
                        R.id.createCategoryContentLayout
                );
